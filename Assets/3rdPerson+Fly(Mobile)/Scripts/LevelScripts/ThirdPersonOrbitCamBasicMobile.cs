...
public class ThirdPersonOrbitCamBasicMobile : MonoBehaviour
{
	...
	{
		//if (!touchMouseChecker.isDragging) return;
		float horizontalAimingSpeed = 8f; // Modify these speeds as needed
		float verticalAimingSpeed = 8f; // Modify these speeds as needed
...
/*		int touchIndex = NonAnalogScreenMove();
		Debug.Log("Event System " + EventSystem.current.IsPointerOverGameObject());

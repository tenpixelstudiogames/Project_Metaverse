...
public class BasicBehaviourMobile : NetworkBehaviour
{
	PhotonView PV;
	...
	void Awake ()
	{
        ...
        {
			playerCamera = GameObject.FindGameObjectWithTag("MainCamera").transform;
			camScript = this.GetComponent<ThirdPersonOrbitCamBasicMobile>();
			//camScript.player = this.transform;
			//camScript.enabled = true;
		}*/
	...
	/*	if (playerCamera.gameObject != null)
		...
		{
			playerCamera = GameObject.FindGameObjectWithTag("MainCamera").transform;
			playerCamera.GetComponent<ThirdPersonOrbitCamBasicMobile>().player = this.transform;
			playerCamera.GetComponent<ThirdPersonOrbitCamBasicMobile>().enabled = true;
			Debug.Log("Player Camera Get");
		}
    ...
    {
		/*Debug.Log("OnClient Connected!!! " +clientId);
	...
	*//*		foreach(var clientIdsLocal in clientIds)
            {
				if (clientId == NetworkManager.Singleton.LocalClientId) return;
				//clients.PlayerObject.GetComponent<BasicBehaviourMobile>().playerCamera = null;
				NetworkManager.Singleton.ConnectedClients[clientIdsLocal].PlayerObject.GetComponent<BasicBehaviourMobile>().playerCamera = null;
				NetworkManager.Singleton.ConnectedClients[clientIdsLocal].PlayerObject.GetComponent<BasicBehaviourMobile>().camScript.player = null;
				Debug.Log("Made the Null");
			}*//*
			//camScript.player = this.transform;
			//camScript.enabled = true;
		...
		if (clientId == NetworkManager.Singleton.LocalClientId)
		{
			Debug.Log("Client id Mathced!!!!");
			return;
		}
		
		NetworkManager.Singleton.ConnectedClients[clientId].PlayerObject.GetComponent<BasicBehaviourMobile>().playerCamera = null;
		NetworkManager.Singleton.ConnectedClients[clientId].PlayerObject.GetComponent<BasicBehaviourMobile>().camScript.player = null;
		Debug.Log("Made the Null!!!");*/
	}

...
namespace Photon.Voice.Unity
{
    ...
    public class Recorder : VoiceComponent
    {
        ...
        private WebRtcAudioDsp webRtcAudio;
        ...
        private void Start()
        {
 /*          webRtcAudio = this.GetComponent<WebRtcAudioDsp>();
#if UNITY_EDITOR || UNITY_ANDROID
            SetAndroidNativeMicrophoneSettings(true, true, true);
            webRtcAudio.enabled = false;
#endif
#if UNITY_IOS
 webRtcAudio.enabled = true;
#endif*/
        }
